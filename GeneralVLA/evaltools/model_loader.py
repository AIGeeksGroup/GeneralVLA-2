...
class SAMModel:
    def __init__(self,model_size='b',args=None):
        ...
        if self.args.grounding_model == 'qwen-lora-box' or self.args.grounding_model == 'qwen-full-box':
            ...
            if model_size == 'b':
                sam_path = os.environ.get('SAM_VIT_B_CHECKPOINT', '')
                ...
                sam_path = os.environ.get('SAM_VIT_H_CHECKPOINT', '')
                if os.path.exists(sam_path):
                    pass
                else:
                    sam_path = args.checkpoint
                ...
                sam_path = os.environ.get('SAM_VIT_L_CHECKPOINT', '')
                if os.path.exists(sam_path):
                    pass
                else:
                    sam_path = args.checkpoint
...
class GroundingModel_Qwen_full(): 
    def __init__(self, model_path, args):
        ...
        self.args = args
        # model_path can point to a local Qwen-VL checkpoint.
